...
if __name__ == "__main__":
    ...
    training_loss       = average(normalize(unpickle(trainlosspath)))
    print("Loading validation data...")
    validation_accuracy = unpickle(validaccpath)
    validation_loss     = average(normalize(unpickle(validlosspath)))

    plot_data(training_accuracy, "accuracy", "Training accuracy")
    plot_data(validation_accuracy, "accuracy", "Validation accuracy")
    plot_data(training_loss, "loss", "Training loss")
    plot_data(validation_loss, "loss", "Validation loss")
    plot_two(training_accuracy, validation_accuracy, "accuracy", "Accuracy", "Training accuracy", "Validation accuracy")
    plot_two(training_loss, validation_loss, "loss", "Loss", "Training loss", "Validation loss")
